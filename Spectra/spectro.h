...
class Spectro : public QDialog
{
  Q_OBJECT

public:
  Spectro(QWidget *parent = 0);
  ~Spectro();
  usb_dev_handle *dev;
...
private:
  ...
  TimeStamp *timeStamp;
  QCheckBox *chebyButton;
  QCheckBox *normalizeButton;
  QRadioButton *infiButton;
  QPushButton *loadLog;
  QPushButton *saveLog;
  QLabel* diesel_a_percentage;
  QLabel* diesel_a_plus_percentage;
  QLabel* diesel_b_percentage;
  QLabel* diesel_c_percentage;
  QLabel* gasolina_95_percentage;
  QLabel* gasolina_98_percentage;
  ...
  void on_AutomateBtn_clicked();
  void on_ChebyshevBtn_clicked();
  void on_NormalizeBtn_clicked();
  void on_infiBtn_clicked();
